...
As described in the [What is a Shader?](./what-is-a-shader/) page, uniforms are simply data that is constant for a single draw call, sent from the CPU to the GPU.
