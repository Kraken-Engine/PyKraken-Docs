...
while kn.window.is_open():
    ...
    kn.renderer.clear(kn.Color(20, 20, 40))
    ...
    if not game_started:
        ...
        title.draw(kn.Vec2(SCN_WIDTH / 2, SCN_HEIGHT / 3), kn.Anchor.CENTER)
        ...
        score_text.draw(kn.Vec2(10, 10))

        # Draw FPS in top-right
        fps_text.text = f"FPS: {int(kn.time.get_fps())}"
        fps_text.draw(kn.Vec2(SCN_WIDTH - 10, 10), kn.Anchor.TOP_RIGHT)
