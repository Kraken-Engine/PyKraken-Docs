...
### Blit
<div className="api-card">
<ApiSig name="blit" multiline params={[{ name: "pixel_array", type: "PixelArray" }, { name: "pos", type: "Vec2" }, { name: "anchor", type: "Anchor", default: "Anchor.CENTER" }, { name: "src", type: "Any", default: "None" }]} returns="None" />
...
- `anchor` : The anchor point for positioning. Defaults to CENTER.
