...
- <ApiSig name="PixelArray" params={[{ name: "size", type: "Vec2" }]} />
- <ApiSig name="PixelArray" params={[{ name: "file_path", type: "str" }]} />

_**Parameters**_
- `size` : The size of the pixel array as (width, height).
...
<ApiSig name="blit" multiline params={[{ name: "pixel_array", type: "PixelArray" }, { name: "pos", type: "Vec2" }, { name: "anchor", type: "Anchor", default: "Anchor.CENTER" }, { name: "src", type: "Rect", default: "None" }]} returns="None" />
...
Scroll the pixel array by the specified amounts in the x and y directions.

_**Parameters**_

- `dx`: The amount to scroll in the x direction.
- `dy`: The amount to scroll in the y direction.
- `scroll_mode`: The scroll mode to use.
