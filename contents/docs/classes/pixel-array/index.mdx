...
- <ApiSig name="PixelArray" params={[{ name: "width", type: "int" }, { name: "height", type: "int" }]} returns="PixelArray" />
- <ApiSig name="PixelArray" multiline params={[{ name: "file_path", type: "str | os.PathLike[str]" }]} returns="PixelArray" />
...
### Blit
<div className="api-card">
<ApiSig name="blit" multiline params={[{ name: "pixel_array", type: "PixelArray" }, { name: "pos", type: "Vec2" }, { name: "anchor", type: "Vec2", default: "..." }, { name: "src", type: "Rect", default: "..." }]} returns="None" />
...
<ApiSig name="blit" multiline params={[{ name: "pixel_array", type: "PixelArray" }, { name: "dst", type: "Rect" }, { name: "src", type: "Rect", default: "..." }]} returns="None" />
...
### Get At
<div className="api-card">
<ApiSig name="get_at" params={[{ name: "x", type: "int" }, { name: "y", type: "int" }]} returns="Color" />
...
### Set At
<div className="api-card">
<ApiSig name="set_at" params={[{ name: "x", type: "int" }, { name: "y", type: "int" }, { name: "color", type: "Color" }]} returns="None" />
...
### Scroll
<div className="api-card">
<ApiSig name="scroll" params={[{ name: "dx", type: "int" }, { name: "dy", type: "int" }, { name: "scroll_mode", type: "ScrollMode" }]} returns="None" />
