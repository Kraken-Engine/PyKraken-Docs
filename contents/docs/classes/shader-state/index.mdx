...
- <ApiSig name="ShaderState" multiline params={[{ name: "fragment_file_path", type: "str | os.PathLike[str]" }, { name: "uniform_buffer_count", type: "int", default: "0" }]} returns="ShaderState" />
...
### Set Uniform
<div className="api-card">
<ApiSig name="set_uniform" multiline params={[{ name: "binding", type: "int" }, { name: "data", type: "NDArray" }]} returns="None" />
