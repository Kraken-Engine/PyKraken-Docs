...
- <ApiSig name="Shader" params={[{ name: "fragment_base_path", type: "str | PathLike[str]" }, { name: "uniform_buffer_count", type: "int", default: "0" }, { name: "sampler_count", type: "int", default: "1" }]} returns="Shader" />
