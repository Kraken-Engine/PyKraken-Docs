...
- <ApiSig name="Shader" params={[{ name: "fragment_base_path", type: "str | os.PathLike[str]" }, { name: "uniform_buffer_count", type: "int", default: "0" }, { name: "sampler_count", type: "int", default: "1" }, { name: "storage_buffer_sizes", type: "Sequence[int]", default: "[]" }]} returns="Shader" />
...
### Set Texture Sampler
<div className="api-card">
<ApiSig name="set_texture_sampler" params={[{ name: "binding", type: "int" }, { name: "texture", type: "Texture" }, { name: "sampler", type: "Sampler" }]} returns="None" />
