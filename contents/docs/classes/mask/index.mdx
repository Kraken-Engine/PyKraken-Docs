...
- <ApiSig name="Mask" multiline params={[{ name: "pixel_array", type: "PixelArray" }, { name: "threshold", type: "int", default: "1" }]} returns="Mask" />
...
### Get Overlap Area
<div className="api-card">
<ApiSig name="get_overlap_area" params={[{ name: "other", type: "Mask" }, { name: "offset", type: "Vec2", default: "..." }]} returns="int" />
...
### Get Overlap Mask
<div className="api-card">
<ApiSig name="get_overlap_mask" params={[{ name: "other", type: "Mask" }, { name: "offset", type: "Vec2", default: "..." }]} returns="Mask" />
...
### Add
<div className="api-card">
<ApiSig name="add" params={[{ name: "other", type: "Mask" }, { name: "offset", type: "Vec2", default: "..." }]} returns="None" />
...
### Subtract
<div className="api-card">
<ApiSig name="subtract" params={[{ name: "other", type: "Mask" }, { name: "offset", type: "Vec2", default: "..." }]} returns="None" />
...
### Collide Mask
<div className="api-card">
<ApiSig name="collide_mask" params={[{ name: "other", type: "Mask" }, { name: "offset", type: "Vec2", default: "..." }]} returns="bool" />
...
<div className="api-card">
<ApiSig name="get_collision_points" params={[{ name: "other", type: "Mask" }, { name: "offset", type: "Vec2", default: "..." }]} returns="list[Vec2]" />
...
### Get Pixel Array
<div className="api-card">
<ApiSig name="get_pixel_array" params={[{ name: "color", type: "Color", default: "..." }]} returns="PixelArray" />
