...
| --- | --- | --- |
| `clip` | The source rectangle (clip) for the current animation frame. | <code><a href="/docs/classes/rect">Rect</a></code> |
...
### Load Sprite Sheet
<div className="api-card">
<ApiSig name="load_sprite_sheet" params={[{ name: "frame_size", type: "Vec2" }, { name: "strips", type: "SheetStripList" }]} returns="None" />
