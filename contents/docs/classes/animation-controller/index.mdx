...
description: Manages and controls sprite animations with multiple animation sequences. Access via the '' submodule.
---
...
### Add Sheet
<div className="api-card">
<ApiSig name="add_sheet" multiline params={[{ name: "frame_size", type: "Vec2" }, { name: "strips", type: "Sequence[SheetStrip]" }]} returns="None" />
