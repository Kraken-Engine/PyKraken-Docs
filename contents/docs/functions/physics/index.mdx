...
<ApiSig name="set_fixed_delta" params={[{ name: "fixed_delta", type: "float" }]} returns="None" />
...
## Set Max Substeps
<div className="api-card">
<ApiSig name="set_max_substeps" params={[{ name: "max_substeps", type: "int" }]} returns="None" />
