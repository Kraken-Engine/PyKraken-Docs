...
<ApiSig name="load_sample" params={[{ name: "path", type: "str | os.PathLike[str]" }, { name: "predecode", type: "bool", default: "True" }]} returns="Sample" />
...
## Load Stream
<div className="api-card">
<ApiSig name="load_stream" params={[{ name: "path", type: "str | os.PathLike[str]" }, { name: "predecode", type: "bool", default: "False" }]} returns="Stream" />
