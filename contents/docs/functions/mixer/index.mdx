...
<ApiSig name="load_sample" multiline params={[{ name: "path", type: "str | os.PathLike[str]" }, { name: "predecode", type: "bool", default: "True" }]} returns="Sample" />
...
## Load Stream
<div className="api-card">
<ApiSig name="load_stream" multiline params={[{ name: "path", type: "str | os.PathLike[str]" }, { name: "predecode", type: "bool", default: "False" }]} returns="Stream" />
...
## Set Master Volume
<div className="api-card">
<ApiSig name="set_master_volume" params={[{ name: "volume", type: "float" }]} returns="None" />
