...
## Points From Ndarray
<div className="api-card">
<ApiSig name="points_from_ndarray" multiline params={[{ name: "points", type: "Annotated[NDArray[numpy.float64], dict(shape=(None, None), order='C', device='cpu', writable=False)]" }, { name: "color", type: "Color" }]} returns="None" />
...
## Circle
<div className="api-card">
<ApiSig name="circle" multiline params={[{ name: "circle", type: "Circle" }, { name: "color", type: "Color" }, { name: "thickness", type: "float", default: "0" }, { name: "num_segments", type: "int", default: "24" }]} returns="None" />
...
## Circles
<div className="api-card">
<ApiSig name="circles" multiline params={[{ name: "circles", type: "Sequence[Circle]" }, { name: "color", type: "Color" }, { name: "thickness", type: "float", default: "0" }, { name: "num_segments", type: "int", default: "24" }]} returns="None" />
...
## Capsule
<div className="api-card">
<ApiSig name="capsule" multiline params={[{ name: "capsule", type: "Capsule" }, { name: "color", type: "Color" }, { name: "thickness", type: "float", default: "0" }, { name: "num_segments", type: "int", default: "24" }]} returns="None" />
...
## Capsules
<div className="api-card">
<ApiSig name="capsules" multiline params={[{ name: "capsules", type: "Sequence[Capsule]" }, { name: "color", type: "Color" }, { name: "thickness", type: "float", default: "0" }, { name: "num_segments", type: "int", default: "24" }]} returns="None" />
...
## Ellipse
<div className="api-card">
<ApiSig name="ellipse" multiline params={[{ name: "bounds", type: "Rect" }, { name: "color", type: "Color" }, { name: "thickness", type: "float", default: "0.0" }, { name: "num_segments", type: "int", default: "24" }]} returns="None" />
...
## Ellipses
<div className="api-card">
<ApiSig name="ellipses" multiline params={[{ name: "bounds", type: "Sequence[Rect]" }, { name: "color", type: "Color" }, { name: "thickness", type: "float", default: "0.0" }, { name: "num_segments", type: "int", default: "24" }]} returns="None" />
...
## Line
<div className="api-card">
<ApiSig name="line" multiline params={[{ name: "line", type: "Line" }, { name: "color", type: "Color" }, { name: "thickness", type: "float", default: "1.0" }]} returns="None" />
...
## Lines
<div className="api-card">
<ApiSig name="lines" multiline params={[{ name: "lines", type: "Sequence[Line]" }, { name: "color", type: "Color" }, { name: "thickness", type: "float", default: "1.0" }]} returns="None" />
...
## Rect
<div className="api-card">
<ApiSig name="rect" multiline params={[{ name: "rect", type: "Rect" }, { name: "color", type: "Color" }, { name: "thickness", type: "int", default: "0" }, { name: "border_radius", type: "float", default: "0.0" }, { name: "radius_top_left", type: "float", default: "-1.0" }, { name: "radius_top_right", type: "float", default: "-1.0" }, { name: "radius_bottom_right", type: "float", default: "-1.0" }, { name: "radius_bottom_left", type: "float", default: "-1.0" }]} returns="None" />
...
## Rects
<div className="api-card">
<ApiSig name="rects" multiline params={[{ name: "rects", type: "Sequence[Rect]" }, { name: "color", type: "Color" }, { name: "thickness", type: "int", default: "0" }, { name: "border_radius", type: "float", default: "0.0" }, { name: "radius_top_left", type: "float", default: "-1.0" }, { name: "radius_top_right", type: "float", default: "-1.0" }, { name: "radius_bottom_right", type: "float", default: "-1.0" }, { name: "radius_bottom_left", type: "float", default: "-1.0" }]} returns="None" />
...
## Geometry
<div className="api-card">
<ApiSig name="geometry" multiline params={[{ name: "texture", type: "Texture | None" }, { name: "vertices", type: "Sequence[Vertex]" }, { name: "indices", type: "Sequence[int]", default: "[]" }]} returns="None" />
...
## Bezier
<div className="api-card">
<ApiSig name="bezier" multiline params={[{ name: "control_points", type: "Sequence[Vec2]" }, { name: "color", type: "Color" }, { name: "thickness", type: "float", default: "1.0" }, { name: "num_segments", type: "int", default: "24" }]} returns="None" />
...
## Sector
<div className="api-card">
<ApiSig name="sector" multiline params={[{ name: "circle", type: "Circle" }, { name: "start_angle", type: "float" }, { name: "end_angle", type: "float" }, { name: "color", type: "Color" }, { name: "thickness", type: "float", default: "0.0" }, { name: "num_segments", type: "int", default: "24" }]} returns="None" />
...
## Polyline
<div className="api-card">
<ApiSig name="polyline" multiline params={[{ name: "points", type: "Sequence[Vec2]" }, { name: "color", type: "Color" }, { name: "thickness", type: "float", default: "1.0" }, { name: "closed", type: "bool", default: "False" }]} returns="None" />
