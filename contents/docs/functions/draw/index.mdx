...
<ApiSig name="point" multiline params={[{ name: "point", type: "Vec2" }, { name: "color", type: "Color" }]} returns="None" />
...
## Points
<div className="api-card">
<ApiSig name="points" multiline params={[{ name: "points", type: "Sequence[Vec2]" }, { name: "color", type: "Color" }]} returns="None" />
...
## Points From Ndarray
<div className="api-card">
<ApiSig name="points_from_ndarray" multiline params={[{ name: "points", type: "NDArray[numpy.float64]" }, { name: "color", type: "Color" }]} returns="None" />
