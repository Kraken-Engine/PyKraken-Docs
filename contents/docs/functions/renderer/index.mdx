...
<ApiSig name="draw" params={[{ name: "texture", type: "Texture" }, { name: "dst", type: "Rect" }]} returns="None" />
...
## Draw Batch
<div className="api-card">
<ApiSig name="draw_batch" multiline params={[{ name: "texture", type: "Texture" }, { name: "transforms", type: "Sequence[Transform]" }, { name: "anchor", type: "Vec2", default: "..." }, { name: "pivot", type: "Vec2", default: "..." }]} returns="None" />
...
<ApiSig name="draw_batch" multiline params={[{ name: "texture", type: "Texture" }, { name: "transforms", type: "Annotated[NDArray[numpy.float64], dict(shape=(None, None), order='C', device='cpu', writable=False)]" }, { name: "anchor", type: "Vec2", default: "..." }, { name: "pivot", type: "Vec2", default: "..." }]} returns="None" />
