...
<ApiSig name="draw_batch" multiline params={[{ name: "texture", type: "Texture" }, { name: "transforms", type: "NDArray[numpy.float64]" }, { name: "anchor", type: "Vec2", default: "..." }, { name: "pivot", type: "Vec2", default: "..." }]} returns="None" />
