...
<ApiSig name="set_default_filter_mode" multiline params={[{ name: "filter", type: "FilterMode" }]} returns="None" />
...
<ApiSig name="draw" multiline params={[{ name: "texture", type: "Texture" }, { name: "dst", type: "Rect" }, { name: "angle", type: "float", default: "0.0" }, { name: "pivot", type: "Vec2", default: "..." }]} returns="None" />
...
- `angle` : The rotation angle in degrees. Defaults to 0.0.
- `pivot` : The rotation pivot (0.0-1.0). Defaults to center (0.5, 0.5).
