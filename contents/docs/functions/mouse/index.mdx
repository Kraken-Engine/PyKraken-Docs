---
title: Mouse
description: Mouse related functions
---
...
## Is Pressed
<div className="api-card">
<ApiSig name="is_pressed" multiline params={[{ name: "button", type: "MouseButton" }]} returns="bool" />
...
## Is Just Pressed
<div className="api-card">
<ApiSig name="is_just_pressed" multiline params={[{ name: "button", type: "MouseButton" }]} returns="bool" />
...
## Is Just Released
<div className="api-card">
<ApiSig name="is_just_released" multiline params={[{ name: "button", type: "MouseButton" }]} returns="bool" />
