...
<ApiSig name="is_pressed" multiline params={[{ name: "button", type: "GamepadButton" }, { name: "slot", type: "int", default: "0" }]} returns="bool" />
...
## Is Just Pressed
<div className="api-card">
<ApiSig name="is_just_pressed" multiline params={[{ name: "button", type: "GamepadButton" }, { name: "slot", type: "int", default: "0" }]} returns="bool" />
...
## Is Just Released
<div className="api-card">
<ApiSig name="is_just_released" multiline params={[{ name: "button", type: "GamepadButton" }, { name: "slot", type: "int", default: "0" }]} returns="bool" />
...
## Get Type
<div className="api-card">
<ApiSig name="get_type" params={[{ name: "slot", type: "int", default: "0" }]} returns="GamepadType" />
