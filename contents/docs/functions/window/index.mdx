...
<ApiSig name="create" multiline params={[{ name: "title", type: "str" }, { name: "width", type: "int" }, { name: "height", type: "int" }, { name: "handle_close", type: "bool", default: "True" }]} returns="None" />
...
- `handle_close` : Whether to automatically handle the window quit event.
...
## Set Icon
<div className="api-card">
<ApiSig name="set_icon" multiline params={[{ name: "path", type: "str | os.PathLike[str]" }]} returns="None" />
...
## Save Screenshot
<div className="api-card">
<ApiSig name="save_screenshot" multiline params={[{ name: "path", type: "str | os.PathLike[str]" }]} returns="None" />
