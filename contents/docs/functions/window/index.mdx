...
## Set Icon
<div className="api-card">
<ApiSig name="set_icon" params={[{ name: "path", type: "str | PathLike[str]" }]} returns="None" />
...
## Save Screenshot
<div className="api-card">
<ApiSig name="save_screenshot" params={[{ name: "path", type: "str | PathLike[str]" }]} returns="None" />
