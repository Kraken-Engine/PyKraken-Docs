...
<ApiSig name="create" params={[{ name: "title", type: "str" }, { name: "width", type: "int" }, { name: "height", type: "int" }, { name: "handle_close", type: "bool", default: "True" }]} returns="None" />
...
## Set Icon
<div className="api-card">
<ApiSig name="set_icon" params={[{ name: "path", type: "str | os.PathLike[str]" }]} returns="None" />
...
## Save Screenshot
<div className="api-card">
<ApiSig name="save_screenshot" params={[{ name: "path", type: "str | os.PathLike[str]" }]} returns="None" />
