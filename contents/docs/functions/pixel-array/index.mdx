...
## Scale To
<div className="api-card">
<ApiSig name="scale_to" multiline params={[{ name: "pixel_array", type: "PixelArray" }, { name: "size", type: "Vec2" }]} returns="PixelArray" />
...
## Scale By
<div className="api-card">
<ApiSig name="scale_by" multiline params={[{ name: "pixel_array", type: "PixelArray" }, { name: "factor", type: "float" }]} returns="PixelArray" />
...
## Rotate
<div className="api-card">
<ApiSig name="rotate" multiline params={[{ name: "pixel_array", type: "PixelArray" }, { name: "angle", type: "float" }]} returns="PixelArray" />
...
## Box Blur
<div className="api-card">
<ApiSig name="box_blur" multiline params={[{ name: "pixel_array", type: "PixelArray" }, { name: "radius", type: "int" }, { name: "repeat_edge_pixels", type: "bool", default: "True" }]} returns="PixelArray" />
...
## Gaussian Blur
<div className="api-card">
<ApiSig name="gaussian_blur" multiline params={[{ name: "pixel_array", type: "PixelArray" }, { name: "radius", type: "int" }, { name: "repeat_edge_pixels", type: "bool", default: "True" }]} returns="PixelArray" />
...
## Invert
<div className="api-card">
<ApiSig name="invert" multiline params={[{ name: "pixel_array", type: "PixelArray" }]} returns="PixelArray" />
...
## Grayscale
<div className="api-card">
<ApiSig name="grayscale" multiline params={[{ name: "pixel_array", type: "PixelArray" }]} returns="PixelArray" />
