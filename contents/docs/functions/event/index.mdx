---
title: Event
description: Functions in event.
---
...
## Schedule
<div className="api-card">
<ApiSig name="schedule" multiline params={[{ name: "event", type: "Event" }, { name: "delay_ms", type: "int" }, { name: "repeat", type: "bool", default: "False" }]} returns="None" />
