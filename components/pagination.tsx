        ...
        {prev && (
          <Link
            className={buttonVariants({
              variant: "outline",
              className:
                "pagination no-underline w-full flex flex-col sm:pl-7 pl-3 sm:py-10 py-8 !items-start text-xs sm:text-sm",
            })}
        ...
        {next && (
          <Link
            className={buttonVariants({
              variant: "outline",
              className:
                "pagination no-underline w-full flex flex-col sm:pr-7 pr-3 sm:py-10 py-8 !items-end text-xs sm:text-sm",
            })}
